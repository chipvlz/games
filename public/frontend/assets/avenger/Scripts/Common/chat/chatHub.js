...
hub.client.systemMessage(systemMessage,type);});hub.on('receiveMessage',function(chatMessage){if(typeof avengerChat!='undefined'&&typeof avengerChat.receiveMessage=='function')
avengerChat.receiveMessage(chatMessage);});hub.on('notification',function(messages){if(typeof hub.client.notification=='function')
hub.client.notification(messages);});hub.on('broadcastMessage',function(messages){if(typeof avengerChat!='undefined'&&typeof avengerChat.broadcastMessage=='function')
avengerChat.broadcastMessage(messages);});return hub;};window.ChatHub=ChatHub;})();